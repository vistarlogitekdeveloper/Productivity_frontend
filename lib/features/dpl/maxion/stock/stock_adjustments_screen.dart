              ...
              return DplCard(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  if ((a.decisionNote ?? '').isNotEmpty)
                    Text('Decision: ${a.decisionNote}', style: TextStyle(color: DplColors.textSecondary, fontSize: 12.5)),
            ...
            itemBuilder: (_, i) {
              ...
              return DplCard(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const SizedBox(height: 2),
                  Text('remaining of opening', style: TextStyle(color: DplColors.textTertiary, fontSize: 11)),
                ]),
              );
            },
          ),
...
class _DplNewStockAdjustmentPageState extends ConsumerState<DplNewStockAdjustmentPage> {
    ...
    return [
      if (_lot != null)
        ...
        if (async.isLoading)
          ...
          Text('No lots match.', style: TextStyle(color: DplColors.textSecondary))
        else
          ConstrainedBox(
  ...
  List<Widget> _wheelFields(bool canCamera) {
    return [
      ...
      const SizedBox(height: 8),
      if (_codes.isEmpty)
        Text('No wheels yet.', style: TextStyle(color: DplColors.textSecondary))
      else ...[
