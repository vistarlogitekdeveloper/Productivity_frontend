        ...
        children: [
          DplCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
              Row(children: [
                const Icon(Icons.visibility_off_outlined, size: 18, color: DplColors.info),
          ...
          const SizedBox(height: 6),
          if (c.lines.isEmpty)
            const Text('Nothing scanned yet.', style: TextStyle(color: DplColors.textSecondary))
          else
            ...
            if (queuedHere > 0)
              Padding(
                ...
                child: Text(
                  ...
                  style: const TextStyle(color: DplColors.warning, fontWeight: FontWeight.w600),
                ),
              ),
            Row(children: [
              Expanded(
      ...
      children: [
        DplCard(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (s['expected'] != null)
              Text('${s['expected']} pallets expected on these racks', style: const TextStyle(color: DplColors.textSecondary)),
            const SizedBox(height: 10),
        ...
        if (count.lines.isEmpty)
          const Text('No lines.', style: TextStyle(color: DplColors.textSecondary))
        else
