              ...
              if (gp.qrToken.isNotEmpty) ...[
                ...
                Column(
                  children: [
                    ...
                    const Text('Security scans this', style: TextStyle(fontSize: 10.5, color: DplColors.textSecondary)),
                  ],
                ),
              ],
            ],
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Icon(Icons.block, color: DplColors.error),
          const SizedBox(width: 10),
          Expanded(
            child: Text(
              'Incomplete: $text. Security will not let the truck out until these are filled in the shipment details.',
              style: const TextStyle(color: DplColors.error, fontWeight: FontWeight.w700),
            ),
          ),
        ],
      ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                SizedBox(
                  width: 92,
                  child: Text(r.$1, style: const TextStyle(fontSize: 12.5, color: DplColors.textSecondary)),
                ),
                Expanded(
                  child: Text(
              ...
              DataCell(Column(
                ...
                children: [
                  ...
                  if (l.description.isNotEmpty)
                    Text(l.description, style: const TextStyle(fontSize: 11.5, color: DplColors.textSecondary)),
                ],
              )),
        ...
        child: Column(
          ...
          children: [
            ...
            if (message != null) ...[
              ...
              Text(message!, textAlign: TextAlign.center, style: const TextStyle(color: DplColors.textSecondary)),
            ],
            if (onRetry != null) ...[
