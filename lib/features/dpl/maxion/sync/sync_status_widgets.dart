...
class _SectionTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Text(text, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: DplColors.textPrimary)),
      );
}
                ...
                child: Column(
                  ...
                  children: [
                    Row(children: [
                      ...
                      if (c.code != null)
                        Text(c.code!, style: const TextStyle(color: DplColors.error, fontWeight: FontWeight.w700, fontSize: 12)),
                    ]),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(children: [
                        ...
                        if (blocked)
                          const Text('BLOCKED', style: TextStyle(color: DplColors.error, fontWeight: FontWeight.w800, fontSize: 12)),
                      ]),
                      const SizedBox(height: 4),
                      Text(
